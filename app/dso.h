...
#define DSO_BACKGROUND			RGB565(32,32,32)

#define DSO_GRID_COLOR 			RGB565(64,64,64)
#define DSO_GRID_FRAME_COLOR 	LCD_WHITE
...
#define DSO_SAMPLES_PER_DIVISION (DSO_GRID_W/DSO_GRID_H_DIVISIONS)
...
#define DSO_TGSWEEP_DRO_COLOR 	LCD_GREEN
#define DSO_TGMODE_DRO_X 		265
#define DSO_TGMODE_DRO_Y 		2
#define DSO_TGMODE_DRO_W 		(6 * 8)
#define DSO_TGMODE_DRO_H 		(4 + 8)
#define DSO_TGMODE_DRO_COLOR 	LCD_GREEN
#define DSO_TGEDGE_DRO_X 		(DSO_TGMODE_DRO_X + 8)
#define DSO_TGEDGE_DRO_Y  		DSO_TGMODE_DRO_Y
#define DSO_TG_EDGE_COLOR 		LCD_CYAN

#define DSO_TRIGGER_MENU_BG		RGB565(64,64,64)
#define DSO_TRIGGER_MENU_FG		RGB565(51,85,126)

#define DSO_TRACE_COLOR 		LCD_CYAN
#define DSO_DEFAULT_COLOR 		LCD_WHITE
